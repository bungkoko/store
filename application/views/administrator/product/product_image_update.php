                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="product_title" id="product_title" class="form-control" placeholder="Masukkan Judul Produk" value="<?php echo $read->product_title; ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-8 col-sm-8 col-xs-7">
                                         <img src="<?php echo base_url().$read->product_image;?>" class="img-responsive">
                                    </div>
                                    <div class="col-lg-4 col-md-8 col-sm-8 col-xs-7">
                                        <div id="kv-avatar-errors-2"></div>
                                        <div class="kv-avatar" style="width:200px;text-align:center">
                                            <input id="upload_image" name="product_image" type="file" class="file-loading" value="<?php echo base_url().$read->product_image;?>">
                                        </div>
                                    </div>
                                </div>
