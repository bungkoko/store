                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="about_title" class="form-control" placeholder="Masukkan Judul tentang" value="<?php echo $read->about_title; ?>">
                                            </div>                                           
                                        </div>
                                    </div>
                                </div>
                                 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-7">
                                        <textarea name="about_description" id="ckeditor"><?php echo $read->about_description ?>
                                        </textarea>
                                    </div>
                                </div>
                                <div class="row clearfix">
